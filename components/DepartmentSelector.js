...
const departmentLabels = [
  ...
  { label: "DEPARTMENT OF CATHOLIC EDUCATION PHILOSOPHY AND PRACTICE", id: "CEPP" },
  ...
  { label: "INSTITUTE FOR THE SCIENCE AND ART OF LEARNING AND TEACHING (SALT)", id: "SALT" },
...
export default function DepartmentSelector({ setDepartment }) {
  return (<Autocomplete options={departmentLabels}        
    onChange={(e, value) => {
