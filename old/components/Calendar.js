...
export default function Calendar({
  ...
  const colorCodes = {
    ...
    ATMOS:
      "bg-amber-500/25 border-amber-500/40 dark:bg-amber-400/20 dark:border-amber-400/40",
    ArtAp:
      "bg-red-500/25 border-red-500/40 dark:bg-red-400/20 dark:border-red-400/40",
    ...
    DECSC:
      "bg-emerald-500/25 border-emerald-500/40 dark:bg-emerald-400/20 dark:border-emerald-400/40",
    DECSCI:
      "bg-cyan-500/25 border-cyan-500/40 dark:bg-cyan-400/20 dark:border-cyan-400/40",
    ...
    ENLIT:
      "bg-yellow-500/25 border-yellow-500/40 dark:bg-yellow-400/20 dark:border-yellow-400/40",
    ...
    HISTO:
      "bg-lime-500/25 border-lime-500/40 dark:bg-lime-400/20 dark:border-lime-400/40",
    HSCI: "bg-red-500/25 border-red-500/40 dark:bg-red-400/20 dark:border-red-400/40",
    HUMAN:
      "bg-rose-500/25 border-rose-500/40 dark:bg-rose-400/20 dark:border-rose-400/40",
    ...
    ITENT:
      "bg-lime-500/25 border-lime-500/40 dark:bg-lime-400/20 dark:border-lime-400/40",
    ITMGT:
      "bg-rose-600/25 border-rose-600/40 dark:bg-rose-400/20 dark:border-rose-400/40",
    ...
    MATSE:
      "bg-blue-600/25 border-blue-600/40 dark:bg-blue-400/20 dark:border-blue-400/40",
    ...
    MTHED:
      "bg-red-600/25 border-red-600/40 dark:bg-red-400/20 dark:border-red-400/40",
    ...
    PHILO:
      "bg-indigo-600/25 border-indigo-600/40 dark:bg-indigo-400/20 dark:border-indigo-400/40",
    PHYED:
      "bg-lime-500/25 border-lime-500/40 dark:bg-lime-400/20 dark:border-lime-400/40",
    PHYS: "bg-violet-500/25 border-violet-500/40 dark:bg-violet-400/20 dark:border-violet-400/40",
    PHYSE:
      "bg-fuchsia-500/25 border-fuchsia-500/40 dark:bg-fuchsia-400/20 dark:border-fuchsia-400/40",
    PNTKN:
      "bg-blue-500/25 border-blue-500/40 dark:bg-blue-400/20 dark:border-blue-400/40",
    POLSC:
      "bg-emerald-600/25 border-emerald-600/40 dark:bg-emerald-400/20 dark:border-emerald-400/40",
    ...
    RELED:
      "bg-pink-600/25 border-pink-600/40 dark:bg-pink-400/20 dark:border-pink-400/40",
    RUSS: "bg-blue-500/25 border-blue-500/40 dark:bg-blue-400/20 dark:border-blue-400/40",
    SCIED:
      "bg-slate-600/25 border-slate-600/40 dark:bg-slate-400/20 dark:border-slate-400/40",
    ...
    SOCDV:
      "bg-pink-600/25 border-pink-600/40 dark:bg-pink-400/20 dark:border-pink-400/40",
    SOCIO:
      "bg-pink-500/25 border-pink-500/40 dark:bg-pink-400/20 dark:border-pink-400/40",
    SOMGT:
      "bg-pink-600/25 border-pink-600/40 dark:bg-pink-400/20 dark:border-pink-400/40",
  ...
  const timeSlots = useMemo(() => {
    ...
    // Find the earliest start time and latest end time across all courses
    ...
    // Generate all time slots from earliest start to latest end, plus one additional slot
    const timeSlots = [];
    let currentMinutes = earliestStart;

    while (currentMinutes <= latestEnd) {
                            ...
                            <div className="space-y-2 text-center">
                              <div
                                className={`font-semibold text-gray-900 dark:text-white leading-tight ${
                                  Object.values(settings).filter(Boolean)
                                    .length <= 2
                                    ? "text-base"
                                    : "text-sm"
                                }`}
                              ...
                              {settings.showTime && (
                                <div
                                  className={`text-gray-600 dark:text-gray-200 font-medium ${
                                    Object.values(settings).filter(Boolean)
                                      .length <= 2
                                      ? "text-sm"
                                      : "text-xs"
                              ...
                              {settings.showInstructor && (
                                <div
                                  className={`text-gray-500 dark:text-gray-300 truncate ${
                                    Object.values(settings).filter(Boolean)
                                      .length <= 2
                                      ? "text-sm"
                                      : "text-xs"
